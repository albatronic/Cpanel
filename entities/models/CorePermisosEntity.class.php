...
class CorePermisosEntity extends EntityComunes {
    ...
    /**
     * Devuelve un objeto CorePerfiles
     * 
     * @return entities/CorePerfiles
     */
    ...
    /**
     * Devuelve un objeto CoreModulos
     *
     * @return entities/CoreModulos
     */
    public function getNombreModulo() {
        if (!($this->NombreModulo instanceof CoreModulos)) {
            $modulo = new CoreModulos();
            $this->NombreModulo = $modulo->find("NombreModulo", $this->NombreModulo);
        }
