 ...
 */
class ErpExistenciasEntity extends Entity {
     ...
     * @var string
     */
    protected $_tableName = 'existencias';
    /**
    ...
    public function getIDAlmacen() {
        if (!($this->IDAlmacen instanceof ErpAlmacenes))
            $this->IDAlmacen = new ErpAlmacenes($this->IDAlmacen);
    ...
    public function getIDUbicacion() {
        if (!($this->IDUbicacion instanceof ErpAlmacenesMapas))
            $this->IDUbicacion = new ErpAlmacenesMapas($this->IDUbicacion);
    ...
    public function getIDLote() {
        if (!($this->IDLote instanceof ErpLotes))
            $this->IDLote = new ErpLotes($this->IDLote);
        return $this->IDLote;
    }
