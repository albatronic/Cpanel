...
";
        ...
        if (isset($context["values"])) { $_values_ = $context["values"]; } else { $_values_ = null; }
        if (isset($context["datos"])) { $_datos_ = $context["datos"]; } else { $_datos_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_macro_, "input", array(0 => $this->getAttribute($_atributos_, "Idioma"), 1 => "field_title", 2 => "text", 3 => ($this->getAttribute($_values_, "controller") . "[Idioma]"), 4 => ($this->getAttribute($_values_, "controller") . "_Idioma"), 5 => $this->getAttribute($_datos_, "Idioma"), 6 => "255", 7 => "CampoTextoLargo", 8 => "2"), "method"), "html", null, true);
        echo "
...
";
    ...
    {
        return array (  44 => 15,  41 => 14,  39 => 13,  30 => 11,  22 => 10,  19 => 9,  90 => 27,  86 => 26,  73 => 23,  68 => 22,  63 => 21,  55 => 20,  50 => 19,  42 => 18,  36 => 14,  33 => 13,  23 => 12,);
    }
}
